...
bb:                                               ; preds = %entry
  ...
  %iptrtoint = ptrtoint %struct.UITextAttribute* %i2 to i64
  call void @_ZN22UIAccessibilityContext5buildE15UITextAttribute(%struct.UIAccessibilityContext* bitcast (%TSo22UIAccessibilityContextV* @"$s4main7contextSo22UIAccessibilityContextVvp" to %struct.UIAccessibilityContext*), i64 %iptrtoint)
